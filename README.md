...
A pasta [vimaka-windows](vimaka-windows/README.md) contem um aplicativo local com interface PWA, instalador Windows, comparativo antes/depois, ferramentas de diagnostico e reparo, links para as 27 solucoes do ecossistema Vimaka. Esta em versao de avaliacao 0.1.7. Consulte os requisitos, limites e instrucoes de compilacao no README do aplicativo.
