...
foreach($name in @('server.mjs','core.mjs','workflow.mjs','benchmark.mjs','storage.mjs','package.json','public','native','README.md','THIRD-PARTY-NOTICES.txt')){Copy-Item -LiteralPath (Join-Path $project $name) -Destination $payload -Recurse}
