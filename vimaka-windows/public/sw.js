const CACHE='vimaka-care-shell-v13';
const SHELL=['/','/style.css','/app.js','/vimaka-logo.png','/icon-192.png','/icon-512.png','/solutions.json','/manifest.webmanifest'];
SHELL.push('/translation-core.js','/visual-dashboard.js','/result-dashboard.js','/usage-chart.js','/dashboard.js','/benchmark-ranking.js','/benchmark-references.json','/i18n.js','/translations.js','/donation.js','/donation.json','/donation-qr.png','/fonts.css',...Array.from({length:9},(_,i)=>`/fonts/font-${i+1}.ttf`));
