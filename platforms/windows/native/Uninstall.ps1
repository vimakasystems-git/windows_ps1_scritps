...
foreach($folder in @([Environment]::GetFolderPath('DesktopDirectory'),[Environment]::GetFolderPath('Programs'))){$link=Join-Path $folder 'Vimaka Workstation Care.lnk';if(Test-Path -LiteralPath $link){Remove-Item -LiteralPath $link}}
